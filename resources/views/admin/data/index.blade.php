...
<ul class="breadcrumb">
       ...
       <li {% if view is empty %} class='active' {% endif %} ><a href="/">  الطلبات الجديدة </a></li>
       <li {% if view == 'deleted' %} class='active' {% endif %} ><a href="?view=deleted">  ()          الطلبات المحذوفة</a></li>
       <li {% if view == 'duplicated' %}  class='active'  {% endif %}   ><a href="?view=duplicated">  ()            الطلبات المكررة</a></li>
       <li {% if view == 'sheets' %} class='active'  {% endif %}    ><a href="?view=sheets">  ()    Google Sheets     </a></li>
       <li {% if view == 'stores' %} class='active'  {% endif %}   ><a href="?view=stores">  ()     من المتاجر  </a></li>
