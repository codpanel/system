                ...
                <fieldset class="content-group mg-t-25 mg-b-25">
                    {% for item in  ALLEMPLOYEES %}
                     <div class="form-group">
                      ...
                      <span class="col-md-6">
                         <input type="number" placeholder='' class="form-control countSendForEmployee"  name="">
                      </span>
                      <span class="col-md-3" id="filler_employee_"></span>
                     </div>
                    {% endfor %}
                </fieldset>
      ...
      <form class="form-horizontal" method='post' action="" autocomplete="off">
        <div id="assign-cities-alert"></div>
               <input type="hidden" name="AssignToCityIDS" id="AssignToCityIDS">
                ...
                <div class="text-right">
                    <button type="submit" class="btn btn-primary" id="assing_to_citie">
                    تعيين الى المدينة
                        <i class="icon-arrow-left13 position-right"></i>
                    </button>
                </div>
      ...
      <form class="form-horizontal" method='post' action="" autocomplete="off">
            <div id="assign-product-alert"></div>
               <input type="hidden" name="AssignToProductIDS" id="AssignToProductIDS">
                ...
                <div class="text-right">
                    <button type="submit" class="btn btn-primary" id="assing_to_product">
                    تعيين الى منتوج
                        <i class="icon-arrow-left13 position-right"></i>
                    </button>
                </div>
